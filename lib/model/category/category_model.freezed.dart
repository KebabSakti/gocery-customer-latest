...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String? name, String? image1, String? description});
}
...
class _$_CategoryModel implements _CategoryModel {
  const _$_CategoryModel({this.id, this.name, this.image1, this.description});
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, image1: $image1, description: $description)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, image1, description);
