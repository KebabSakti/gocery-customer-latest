...
abstract class $ThemeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ThemeMode themeMode, bool loading, Exception? exception});
}
...
class _$_ThemeState implements _ThemeState {
  const _$_ThemeState(
      {this.themeMode = ThemeMode.light, this.loading = false, this.exception});
  ...
  @override
  String toString() {
    return 'ThemeState(themeMode: $themeMode, loading: $loading, exception: $exception)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, themeMode, loading, exception);
...
abstract class _ThemeState implements ThemeState {
  const factory _ThemeState(
      {final ThemeMode themeMode,
      final bool loading,
      final Exception? exception}) = _$_ThemeState;
